...
<head>
    ...
    <style>
        .browser-container { padding: 20px; max-width: 1000px; margin: 0 auto; background: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        .breadcrumb { font-size: 18px; margin-bottom: 20px; color: #333; }
        .breadcrumb a { text-decoration: none; color: #007bff; }
        .file-grid { display: flex; flex-wrap: wrap; gap: 15px; }
        .file-item { width: 120px; text-align: center; cursor: pointer; padding: 10px; border-radius: 8px; transition: background 0.3s; word-wrap: break-word;}
